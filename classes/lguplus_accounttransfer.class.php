...
class lguplus_accounttransfer extends lguplus_card_gateway
{
    ...
    public function get_the_title(){
        return __('LG U+ 계좌이체', GNUPAY_LGUPLUS);
    }

    public function get_the_description() {

        $return_html = __( 'LG U+ 계좌이체입니다.', GNUPAY_LGUPLUS );
    ...
    public function process_admin_options(){
        ...
        if( $result ){
            ...
            if(isset($lguplus_options['de_bank_use']) && $op_enabled != $lguplus_options['de_bank_use']){

                $lguplus_options['de_bank_use'] = $op_enabled;
...
}   //end class lguplus_accounttransfer
?>