...
class lguplus_easypay extends lguplus_card_gateway
{
    ...
    public function get_the_title(){
        return __('LG U+ 간편결제', GNUPAY_LGUPLUS);
    }

    public function get_the_description() {

        $return_html = __( 'LG U+ 간편결제입니다.', GNUPAY_LGUPLUS );
