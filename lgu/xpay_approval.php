...
$order_id = isset($_POST['oid']) ? sanitize_text_field($_POST['oid']) : 0;
...
$order_action_url = add_query_arg(array('wc-api'=>'gnupay_lguplus_returnurl'), home_url( '/' ));

$LGD_RETURNURL			    = add_query_arg(array('lgupay'=>'returnurl'), $order_action_url);
$LGD_KVPMISPNOTEURL         = add_query_arg(array('lgupay'=>'note_url'), $order_action_url);

//LGD_KVPMISPWAPURL 에 & 문자열이 있으면 에러난다
$LGD_KVPMISPWAPURL		    = GNUPAY_LGUPLUS_URL.'lgu/mispwapurl.php?LGD_OID='.$LGD_OID;
$LGD_KVPMISPCANCELURL       = add_query_arg(array('lgupay'=>'cancel_url'), $order_action_url);
$LGD_MTRANSFERWAPURL        = add_query_arg(array('lgupay'=>'returnurl'), $order_action_url);
$LGD_MTRANSFERCANCELURL     = add_query_arg(array('lgupay'=>'cancel_url'), $order_action_url);
$LGD_MTRANSFERNOTEURL       = add_query_arg(array('lgupay'=>'note_url'), $order_action_url);
...
WC()->session->set( 'PAYREQ_MAP' , $payReqMap );
