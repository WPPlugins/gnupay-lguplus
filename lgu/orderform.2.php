...
$config['de_admin_company_name'] = apply_filters('gp_lguplus_de_admin_company_name', get_bloginfo('name'));

GNUPAY_LGUPLUS()->config = $config;
...
<form id="gnupay_lguplus_form" name="gnupay_lguplus_form" method="POST">
<?php
    /* ============================================================================== */
    /* =   2. 가맹점 필수 정보 설정                                                 = */
    /* = -------------------------------------------------------------------------- = */
